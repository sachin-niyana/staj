    ...
    <div className="bg-white">
      <div className="container max-w-[1464px] mx-auto px-3 pt-[120px] pb-[157px]">
        ...
        <div className="flex lg:flex-row flex-col justify-center gap-8 items-center">
          <div className=" bg-white rounded-xl sm:py-12 px-4 sm:px-9 max-w-[704px] shadow-[0_0px_12px_0px_rgba(0,0,0,0.07)]">
          ...
          <div className=" bg-white rounded-xl sm:py-12 py-8 px-4 sm:px-9 max-w-[704px] shadow-[0_0px_12px_0px_rgba(0,0,0,0.07)]">
            <div className="flex sm:flex-row flex-col justify-start gap-6 items-center">
