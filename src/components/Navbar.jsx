        ...
        <nav className="bg-white py-0 xl:pt-9">
            <div className="max-w-[1464px] px-3 mx-auto">
                <div className="flex justify-between items-center w-full">
                    ...
                    <ul className={` gap-10 mb-0 bg-white  duration-300 flex flex-column  pl-0 lg:hidden list-none ${show ? "absolute left-0 w-full top-0 flex-col justify-center items-center h-full" : "left-[-100%]"
                        }`}>
                        <li>
                            <a className="ff-poippins text-md text-darkblue hover:text-golden  duration-300" href="#">Home</a>
                        </li>
