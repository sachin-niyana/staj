        ...
        <div className='pt-14 pb-[120px] sm:pt-[80px] md:py-[120px]'>
            <div className='max-w-[1464px] mx-auto px-3 relative'>
                ...
                <div className="flex sm:flex-row flex-col sm:border gap-5 sm:gap-0 justify-between py-[6px] mt-[60px] items-center px-[6px] border-[#d7d7d7] sm:rounded-[48px] mx-auto max-w-[640px]">
                    <div
                        className={`xl:mr-4 px-4 py-1 duration-300 lg:py-[14px] ${activeTab === 'tab1' ? 'text-center text-md ff-poppins font-semibold py-[14px] ps-10 lg:ps-[63px] rounded-[100px] pe-10 lg:pe-[57px] bg-golden text-darkblue' : 'bg-white text-darkblue'}`}
                    ...
                    <div
                        className={`px-4 py-1 duration-300 lg:py-[14px] ${activeTab === 'tab3' ? 'text-center text-md ff-poppins font-semibold py-[14px] ps-10 lg:ps-[63px] rounded-[100px] pe-10 lg:pe-[57px] bg-golden text-darkblue' : 'mr-4 bg-white text-darkblue'}`}
                ...
                {activeTab === 'tab1' && <div>
                    <div className="flex flex-wrap justify-center flex-row mt-[60px] gap-5 lg:gap-0 -mx-3 relative">
                        ...
                        <img className='absolute top-[-50%] max-w-[215px] start-5' src={circlevec} alt="circle-vectors" />
