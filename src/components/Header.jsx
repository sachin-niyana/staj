    ...
    return (
        <>
            <div className="bg-skyblue overflow-x-">
                ...
                <div className="bg-[rgba(250,229,229)] h-[56px] md:h-[66px] mt-[70px] lg:-mt-[67px] md:mt-[-30px]  z-2">
                    <div className="bg-orange 2xl:hidden z-3 top-0 flex items-center justify-center w-[101%] -mx-1 h-[56px] md:h-[66px] opacity-100 -rotate-2">
                        <Marquee>   <div class="scroll-container">
                            <div class="scroll-content flex items-center justify-center">
                                ...
                                <img class="max-w-[54px] md:max-w-[64px] mx-10" src={circles} alt="circles" />
                    ...
                    <div className="bg-orange w-[101%] 2xl:flex hidden z-3 top-0  items-center justify-center -mx-1 h-[56px] md:h-[66px] opacity-100 -rotate-2">
