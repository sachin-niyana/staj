        ...
        <>
            <div className="bg-skyblue">
                <div className="max-w-[1464px] px-3 mx-auto">
                    <div className="flex lg:justify-between pt-[72px]">
                        <div className="flex flex-col mt-[153px]">
                            ...
                            <button className="bg-golden block font-poppins text-base h-[64px] hover:bg-darkblue hover:text-white duration-300 w-[212px] font-bold capitalize py-5 px-10 rounded-[30px] mt-[60px] text-darkblue">
                                DOWNLOAD APP
                            </button>
                        </div>
                        <div>
